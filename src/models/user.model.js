...
const createUser = async ({ first_name, last_name, email, phone, password, role_id, discount_percent, is_active, deactivated_at }) => {
  ...
  return new Promise((resolve, reject) => {
    ...
    db.run(sql, [first_name, last_name, email, phone || null, hash, role_id || null, discount_percent || 0.00, typeof is_active !== 'undefined' ? (is_active ? 1 : 0) : 1, deact], function (err) {
